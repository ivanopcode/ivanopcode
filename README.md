...
- **[telegram-stories-analytics](https://github.com/ivanopcode/telegram-stories-analytics):** Cross-platform
  `tg-stories` CLI for Telegram Stories viewer exports, regular-viewer analytics, reaction rankings, and local
  HTML reports.
...
- **[CocoaSkills](https://github.com/ivanopcode/cocoaskills):** Dependency manager for AI agent skills.
  Declarative, reproducible, and multi-agent ready.
